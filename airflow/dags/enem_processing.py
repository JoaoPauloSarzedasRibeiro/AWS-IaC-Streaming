...
def pipeline_enem():
    ...
    def emr_process_enem_data():
        cluster_id = client.run_job_flow(
            Name='EMR-JPSR-Enem2020',
            ServiceRole='EMR_DefaultRole',
            JobFlowRole='EMR_EC2_DefaultRole',
            VisibleToAllUsers=True,
            LogUri='s3://datalake-jpsr-703165468389-tf/emr-logs',
            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit',
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://datalake-jpsr-703165468389-tf/emr-code/pyspark/01_delta_spark_insert.py'
                        ]
                }
            }],
        )
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                '--master', 'yarn',
                                '--deploy-mode', 'cluster',
                                's3://datalake-jpsr-703165468389-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                            ]
                    }
                }]
            )
